...
// CreateCertificateSigningRequestApprovalJSONRequestBody defines body for CreateCertificateSigningRequestApproval for application/json ContentType.
type CreateCertificateSigningRequestApprovalJSONRequestBody = CertificateSigningRequest
