...
type ClientInterface interface {
	...
	// CreateCertificateSigningRequestApprovalWithBody request with any body
	CreateCertificateSigningRequestApprovalWithBody(ctx context.Context, name string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	CreateCertificateSigningRequestApproval(ctx context.Context, name string, body CreateCertificateSigningRequestApprovalJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) CreateCertificateSigningRequestApprovalWithBody(ctx context.Context, name string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateCertificateSigningRequestApprovalRequestWithBody(c.Server, name, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CreateCertificateSigningRequestApproval(ctx context.Context, name string, body CreateCertificateSigningRequestApprovalJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateCertificateSigningRequestApprovalRequest(c.Server, name, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewCreateCertificateSigningRequestApprovalRequest calls the generic CreateCertificateSigningRequestApproval builder with application/json body
func NewCreateCertificateSigningRequestApprovalRequest(server string, name string, body CreateCertificateSigningRequestApprovalJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewCreateCertificateSigningRequestApprovalRequestWithBody(server, name, "application/json", bodyReader)
}

// NewCreateCertificateSigningRequestApprovalRequestWithBody generates requests for CreateCertificateSigningRequestApproval with any type of body
func NewCreateCertificateSigningRequestApprovalRequestWithBody(server string, name string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// CreateCertificateSigningRequestApprovalWithBodyWithResponse request with any body
	CreateCertificateSigningRequestApprovalWithBodyWithResponse(ctx context.Context, name string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateCertificateSigningRequestApprovalResponse, error)

	CreateCertificateSigningRequestApprovalWithResponse(ctx context.Context, name string, body CreateCertificateSigningRequestApprovalJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateCertificateSigningRequestApprovalResponse, error)
...
type CreateCertificateSigningRequestApprovalResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *CertificateSigningRequest
	JSON401      *Error
...
// Status returns HTTPResponse.Status
func (r CreateCertificateSigningRequestApprovalResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r CreateCertificateSigningRequestApprovalResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// CreateCertificateSigningRequestApprovalWithBodyWithResponse request with arbitrary body returning *CreateCertificateSigningRequestApprovalResponse
func (c *ClientWithResponses) CreateCertificateSigningRequestApprovalWithBodyWithResponse(ctx context.Context, name string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateCertificateSigningRequestApprovalResponse, error) {
	rsp, err := c.CreateCertificateSigningRequestApprovalWithBody(ctx, name, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateCertificateSigningRequestApprovalResponse(rsp)
}

func (c *ClientWithResponses) CreateCertificateSigningRequestApprovalWithResponse(ctx context.Context, name string, body CreateCertificateSigningRequestApprovalJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateCertificateSigningRequestApprovalResponse, error) {
	rsp, err := c.CreateCertificateSigningRequestApproval(ctx, name, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateCertificateSigningRequestApprovalResponse(rsp)
...
// ParseCreateCertificateSigningRequestApprovalResponse parses an HTTP response from a CreateCertificateSigningRequestApprovalWithResponse call
func ParseCreateCertificateSigningRequestApprovalResponse(rsp *http.Response) (*CreateCertificateSigningRequestApprovalResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &CreateCertificateSigningRequestApprovalResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
