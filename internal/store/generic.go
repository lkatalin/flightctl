...
type Model interface {
	model.AuthProvider | model.CertificateSigningRequest | model.Device | model.EnrollmentRequest | model.AttestationReference | model.Fleet | model.Repository | model.ResourceSync | model.TemplateVersion | model.Event
}
